...
> Mozilla color-scheme docs: [MDN docs](https://developer.mozilla.org/en-US/docs/Web/CSS/color-scheme)
...
To set system theme you can use `color-scheme` attribute on `root` element.

It will apply dark when your system has dark theme and light when your system has light theme.
