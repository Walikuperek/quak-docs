    ...
    <article className="flex flex-col align-between h-full relative">
        ...
        <header className="flex flex-col px-4 pb-4 pt-4">
            <div className="flex flex-row justify-between items-center mb-3 border-b-2 border-b-indigo-300">
                <h1 className="text-2xl font-bold">Monolith Architecture</h1>
                <p className="mt-2 text-lg text-gray-500">Kacper Walczak &middot; 28-04-2024</p>
            </div>
            <p className="mt-2 text-lg">Lets learn what is and when to use Monolith.</p>
        </header>
    </article>
</section>
...
In this article we will find ways to use Monolith in our projects.
...
In this article we have learned how to and when utilize Monolith architecture.
