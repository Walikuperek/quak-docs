...
<Cards>
  <Card title="👤 1. DTO" href="#example" />
  <Card title="🏪 2. Repository" href="#example" />
  <Card title="💰 3. Domain" href="#example" />
  <Card title="📈 4. Use Case" href="#example" />
</Cards>
...
<Tabs items={['fetch-user.dto.ts', 'user.model.ts', 'user.repository.ts', 'user-creation.service.ts']}>
  <Tab>
  ```typescript
